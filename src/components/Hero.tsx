...
export default function Hero() {
  ...
  const socials = [
    ...
    { icon: Linkedin, href: 'https://www.linkedin.com/in/dhruv-khandelwal1/', label: 'LinkedIn' },
  ...
  return (
    ...
    >
      ...
      >
        Final-year student at <strong style={{ color: '#e8f0fe' }}>IIT Roorkee</strong> building
        multi-agent AI systems, RAG pipelines, and ML solutions that solve real-world problems at scale.
        <strong style={{ color: '#4f8ef7' }}> AIR 1908 in JEE Mains.</strong>
      </motion.p>
      ...
      >
        {socials.map(({ icon: Icon, href, label }) => (
          <motion.a
            ...
            rel="noreferrer"
            aria-label={label}
            whileHover={{ scale: 1.15, color: '#4f8ef7', borderColor: '#4f8ef7' }}
            style={{
              width: 40,
              height: 40,
              borderRadius: '8px',
